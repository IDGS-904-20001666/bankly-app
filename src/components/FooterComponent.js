        ...
        <>
            <footer className="footer p-10 bg-base-200 text-base-content">
                <nav>
                    ...
                    <a className="link link-hover">Condusef</a> 
                    <a className="link link-hover">CNBV</a> 
                </nav> 
                <nav>
                    <header className="footer-title">Recursos</header> 
                    <a className="link link-hover">Educación financiera</a> 
                    <a className="link link-hover">Carreras</a> 
                    <a className="link link-hover">Seguridad</a> 
                </nav> 
                <nav>
